...
class TestFilterResults(unittest.TestCase):
    ...
    def test_metagenomic_results_abricate(self):
        f =  FilterResults(os.path.join(data_dir, 'metagenomic_results.abricate'), os.path.join(data_dir, 'database'), 0, None, False)
    ...
    def test_metagenomic_results_staramr(self):
        f =  FilterResults(os.path.join(data_dir, 'metagenomics_results.staramr'), os.path.join(data_dir, 'database'), 0, None, False)
